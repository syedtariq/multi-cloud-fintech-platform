...
# US Cross-Cloud Replication Module
module "us_cross_cloud_replication" {
  source = "./modules/cross-cloud-replication"
  
  name_prefix              = "${local.name_prefix}-us"
  vpc_id                   = module.us_networking.vpc_id
  private_subnet_ids       = module.us_networking.private_subnet_ids
  private_route_table_ids  = module.us_networking.private_route_table_ids
  rds_cluster_endpoint     = module.us_database.rds_cluster_endpoint
  redis_primary_endpoint   = module.us_database.redis_primary_endpoint
